...
return [
    ...
    'exists'               => ':attribute с данным значением не существует',
    ...
    'in'                   => 'Допустимые значения для :attribute: :values.',
    ...
    'prohibited'           => 'Изменение значения поля :attribute запрещено.',
    'prohibited_if'        => 'Изменение значения поля :attribute запрещено, когда :other равно :value.',
    'prohibited_unless'    => 'Изменение значения поля :attribute запрещено, если :other не состоит в :values.',
    'prohibits'            => 'Изменение значения поля :attribute запрещает присутствие :other.',
    ...
    'unique'               => 'Такое значение поля :attribute уже занято. Пожалуйста, введите другое значение.',
    ...
    'passport_number' => 'Атрибут :attribute должен иметь формат ZZ1234567 (2 заглавные буквы, за которыми следуют 7 цифр).'
];
